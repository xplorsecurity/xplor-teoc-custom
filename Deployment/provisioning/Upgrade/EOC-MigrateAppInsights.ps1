...
# function: Update Classic Application Insights to Workspace based Application Insights
...
$subscriptionId = Read-Host "Please enter the subscription id of the resources where TEOC App is deployed"
